...
def main(model_filename='iML1515.json', analysis=None, analysis_type='FBA'):
    ...
    subst = 'subst'
    count = '0'
    output_filename = VizAn.final_output_svg_file_name(prod, subst, count)
    VizAn.Call_Vizan(model, sol, analysis_type, output_filename)
...
def perform_visualisation(model_file_path='iML1515.json', svg_file_path='E_coli_source.svg', analysis_type='FBA',
    ...
    count = '0'
    output_filename = VizAn.final_output_svg_file_name(prod, subst, count)
    VizAn.call_vizan_cli(model, svg_file_path, analysis_results, analysis_type, output_filename)
